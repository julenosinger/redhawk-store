...
// ../.wrangler/tmp/bundle-MfaX3c/checked-fetch.js
...
// ../.wrangler/tmp/bundle-MfaX3c/strip-cf-connecting-ip-header.js
...
var St = /* @__PURE__ */ __name((t, e, s) => e in t ? kt(t, e, { enumerable: true, configurable: true, writable: true, value: s }) : t[e] = s, "St");
var u = /* @__PURE__ */ __name((t, e, s) => St(t, typeof e != "symbol" ? e + "" : e, s), "u");
var Oe = /* @__PURE__ */ __name((t, e, s) => e.has(t) || Ve("Cannot " + s), "Oe");
var r = /* @__PURE__ */ __name((t, e, s) => (Oe(t, e, "read from private field"), s ? s.call(t) : e.get(t)), "r");
var h = /* @__PURE__ */ __name((t, e, s) => e.has(t) ? Ve("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), "h");
var g = /* @__PURE__ */ __name((t, e, s, a) => (Oe(t, e, "write to private field"), a ? a.call(t, s) : e.set(t, s), s), "g");
var x = /* @__PURE__ */ __name((t, e, s) => (Oe(t, e, "access private method"), s), "x");
var Ge = /* @__PURE__ */ __name((t, e, s, a) => ({ set _(o) {
  g(t, e, o, s);
}, get _() {
  return r(t, e, a);
} }), "Ge");
var Ke = /* @__PURE__ */ __name((t, e, s) => (a, o) => {
  let i = -1;
  return n(0);
  async function n(d) {
    if (d <= i)
...
var $t = /* @__PURE__ */ __name((t) => Ue(t, decodeURI), "$t");
var it = /* @__PURE__ */ __name((t) => {
...
var Fe = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? Ue(t, lt) : t) : t, "Fe");
var nt = /* @__PURE__ */ __name((t, e, s) => {
  let a;
  if (!s && e && !/[%+]/.test(e)) {
    let n = t.indexOf("?", 8);
    if (n === -1)
...
var _t = nt;
var Bt = /* @__PURE__ */ __name((t, e) => nt(t, e, true), "Bt");
var lt = decodeURIComponent;
var Ye = /* @__PURE__ */ __name((t) => Ue(t, lt), "Ye");
var ce;
var C;
var F;
var ct;
...
var H;
var Qe;
var dt = (Qe = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", s = [[]]) {
    h(this, F);
    u(this, "raw");
    h(this, ce);
...
}, "Qe"), ce = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakSet(), ct = /* @__PURE__ */ __name(function(t) {
  const e = r(this, C)[0][this.routeIndex][1][t], s = x(this, F, He).call(this, e);
  return s && /\%/.test(s) ? Ye(s) : s;
}, "ct"), pt = /* @__PURE__ */ __name(function() {
  ...
  return t;
}, "pt"), He = /* @__PURE__ */ __name(function(t) {
  return r(this, C)[1] ? r(this, C)[1][t] : t;
}, "He"), H = /* @__PURE__ */ new WeakMap(), Qe);
var Pt = { Stringify: 1 };
var ft = /* @__PURE__ */ __name(async (t, e, s, a, o) => {
...
var Ne = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "Ne");
var ve = /* @__PURE__ */ __name((t, e) => new Response(t, e), "ve");
var Ae;
var ze;
var _;
var pe;
...
var ne;
var Ze;
var Ft = (Ze = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    h(this, U);
    h(this, Ae);
    h(this, ze);
    ...
    u(this, "html", (t2, e2, s) => {
      const a = /* @__PURE__ */ __name((o) => x(this, U, ne).call(this, o, e2, Ne("text/html; charset=UTF-8", s)), "a");
...
var ut = /* @__PURE__ */ __name(class extends Error {
}, "ut");
var Ut = "__COMPOSED_HANDLER";
var Wt = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "Wt");
...
var Le;
var ue;
var qt = (ue = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    h(this, w);
    u(this, "get");
    u(this, "post");
  ...
  route(e, s) {
    ...
    return s.routes.map((o) => {
      var n;
      let i;
      s.errorHandler === Je ? i = o.handler : (i = /* @__PURE__ */ __name(async (d, l) => (await Ke([], s.errorHandler)(d, () => o.handler(d, l))).res, "i"), i[Ut] = o.handler), x(n = a, w, Y).call(n, o.method, o.path, i);
    }), this;
  }
  basePath(e) {
  ...
  mount(e, s, a) {
    let o, i;
    a && (typeof a == "function" ? i = a : (i = a.optionHandler, a.replaceRequest === false ? o = /* @__PURE__ */ __name((l) => l, "o") : o = a.replaceRequest));
    const n = i ? (l) => {
      const c = i(l);
...
}, "ue"), M = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakSet(), bt = /* @__PURE__ */ __name(function() {
...
}, "bt"), D = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ __name(function(e, s, a) {
...
}, "Y"), Ie = /* @__PURE__ */ __name(function(e, s) {
  if (e instanceof Error)
    return this.errorHandler(e, s);
  throw e;
}, "Ie"), Le = /* @__PURE__ */ __name(function(e, s, a, o) {
  if (o === "HEAD")
...
var ht = [];
function Vt(t, e) {
  const s = this.buildAllMatchers(), a = /* @__PURE__ */ __name((o, i) => {
...
var I;
var se;
var Yt = (se = /* @__PURE__ */ __name(class {
  constructor() {
    h(this, Q);
    h(this, Z);
...
var Me;
var et;
var Jt = (et = /* @__PURE__ */ __name(class {
  constructor() {
...
var yt;
var tt;
var es = (tt = /* @__PURE__ */ __name(class {
  constructor() {
    h(this, _e);
...
}, "tt"), W = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakSet(), yt = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let s = t === v;
...
var P;
var st;
var ts = (st = /* @__PURE__ */ __name(class {
  constructor(t) {
...
var J;
var he;
var as = (he = /* @__PURE__ */ __name(class {
  constructor(e, s, a) {
    h(this, O);
    h(this, G);
    h(this, A);
...
}, "he"), G = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakSet(), J = /* @__PURE__ */ __name(function(e, s, a, o, i) {
...
var te;
var at;
var os = (at = /* @__PURE__ */ __name(class {
  constructor() {
...
var mt = /* @__PURE__ */ __name(class extends qt {
  constructor(t = {}) {
...
// ../.wrangler/tmp/bundle-MfaX3c/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-MfaX3c/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.5875258660714584.mjs.map
